  ...
  <MdLocationOn className="text-blue-500 mr-1" /> {packageDetails.startingCity} to {packageDetails.endingCity}
            ...
            <div className="flex flex-col">
              ...
              <div className="flex space-x-3 mt-2">
                <p className="w-16 h-16 bg-gray-900 flex flex-col items-center justify-center px-4 py-3 shadow-xl rounded-lg">
                  {" "}
                  <GiMeal />{" "}
                  <span className="text-xs mt-2 tracking-wide">Meals</span>
                </p>
                <p className="w-16 h-16 bg-gray-900 flex flex-col items-center justify-center px-4 py-3 shadow-xl rounded-lg">
                  {" "}
                  <FaCar />{" "}
                  <span className="text-xs mt-2 tracking-wide">Stays</span>
                </p>
                <p className="w-16 h-16 bg-gray-900 flex flex-col items-center justify-center px-4 py-3 shadow-xl rounded-lg">
                  {" "}
                  <MdOutlineHomeWork />{" "}
                  <span className="text-xs mt-2 tracking-wide">Transfer</span>
                </p>
                <p className="w-16 h-16 bg-gray-900 flex flex-col items-center justify-center px-4 py-3 shadow-xl rounded-lg">
                  {" "}
                  <TbTrekking />{" "}
                  <span className="text-xs mt-2 tracking-wide">Activities</span>
                </p>
              </div>
            </div>
            ...
            <p className="mb-2 mt-2">
              <strong>Location:</strong> {packageDetails.city.name},{" "}
              {packageDetails.state.name}
            </p>
        ...
        <div className="mt-8 mx-12">
          {packageDetails.itinerary ? (
            <div>
              <h2 className="text-3xl font-semibold mt-5 mb-8 text-blue-500">
                Itinerary
              </h2>
              ...
              <div className="relative">
                ...
                {Object.keys(packageDetails.itinerary || {}).map(
                  (dayKey, dayIndex) => {
                          ...
                          {day.overnightStay && (
                            <div className="mt-2">
                              <p className="font-semibold text-gray-400">
                                Overnight Stay:{" "}
                                <span className="font-light italic text-blue-400">
                                  {day.overnightStay}
                                </span>
                              </p>
                              <p className="text-gray-600"></p>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 mx-14">
          Similar Packages
        </h2>
